...
add_shortcode('golf_rounds_pivot', function () {
  ...
  <div id="grp5-app" class="grp5">
    ...
    <div class="grp5-tablewrap" id="grp5-tablewrap"><div class="grp5-loading">Loading…</div></div>
  ...
  (function(){
    ...
    pager.addEventListener('click', (e) => {
      ...
      // ignore disabled/current clicks
...
function grp5_load() {
  check_ajax_referer('grp5_nonce', 'nonce'); // nonce verification for AJAX requests [web:33]
  global $wpdb;
  ...
  // Render pagination (simple, clear, spaced)
  ob_start();
  if ($totalPages > 1) {

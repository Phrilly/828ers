...
DAYS_IN_ADVANCE = 7 # Default window for Ramsey
...
def book_tee_time(session, target_date, target_time):
    """Attempts to lock and confirm a tee time."""
    ...
    # 3. PLAYER INJECTION (Phil B & Jason C)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test", action="store_true", help="Try to book 18:00 TODAY")
    ...
    if args.test:
        ...
        # Weekday Safety Check (Skipped for --test)

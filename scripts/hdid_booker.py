...
DAYS_IN_ADVANCE = 14 # Updated to 2 weeks per your club's rules
...
def book_tee_time(session, target_date, target_time):
    ...
    if not form:
        ...
        elif "no longer available" in r_lock.text.lower():
            print("    Reason: Online booking is closed for this time.")
        else:
            print("    Reason: Timesheet might not be open yet or unexpected page returned.")
        return False
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test", action="store_true", help="Try 17:52 in 14 days time")
    ...
    if args.test:
        # Test targets exactly 14 days from now at 17:52
        target_date_obj = datetime.today() + timedelta(days=14)
        target_date = target_date_obj.strftime("%Y-%m-%d")
        target_time = "17:52"
        is_test = True
    else:
        # Production uses the window defined in configuration
    ...
    # Polling loop: 1 attempt for test, 30 for production
